...
<body class="<?php echo $body_class; ?> clr-def" id="top">
...
?>
<header class="header por poa-bf bg_clr-body-bf ts-fast-bf op0-bf<?php echo $header_add_class; ?>">
  <div class="flx flx-btw-ctr">
    <h1 class="header--logo ts por"><a href="<?php echo home_url(); ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/common/logo-hor.svg" alt="<?php echo wp_title(); ?>" width="160"></a></h1>
    <nav class="header--nav flx flx-end-ctr flx-1">
        ...
        <?php foreach ($nav_list as $nav_k => $nav_v): ?>
          <?php if ( $nav_v['header'] ): ?>
            ...
            <li class="hnav_list--item hnav_list--item-<?php echo $nav_add_class; ?>">
              <?php
              $nav_tag_class = 'hnav_list--item_in flx flx-ctr flx-col por hov_area';
              $nav_target = '';
              ...
              if ( $nav_v['label-en'] ) {
                $nav_label .= '<span class="txt fnt-en">'.$nav_v['label-en'].$ico_arrow.'</span>';
              }
              if ( $nav_v['label-jp'] ) {
      ...
      ============================================================================ */
      ?>
      <div class="gnav_btn gnav_btn-<?php echo GNAV_BTN_TYPE; ?> por flx flx-ctr">
